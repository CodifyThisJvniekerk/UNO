...
namespace BudgetAppUNO
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source C:\Users\bbdnet1522\source\repos\BudgetAppUNO\BudgetAppUNO.Shared\App.xaml (Line 1:2)
			...
			global::BudgetAppUNO.Skia.Tizen.GlobalStaticResources.Initialize();
			global::BudgetAppUNO.Skia.Tizen.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::BudgetAppUNO.Skia.Tizen.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::BudgetAppUNO.Skia.Tizen.Resource.Drawable);
			#endif
			Resources = 
			new global::Microsoft.UI.Xaml.Controls.XamlControlsResources()
			;
			// Source ..\..\..\..\..\..\..\BudgetAppUNO.Shared\App.xaml (Line 1:2)
		}
	}
}
namespace BudgetAppUNO.Skia.Tizen
{
	static class App_cd28eaf946dae38fa215a6511fe550adXamlApplyExtensions
	{
	}
}
